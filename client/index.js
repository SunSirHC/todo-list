  ...
  fetch('/api/tasks')
    ...
    .then((response) => {
      response.forEach((task) => {
        ...
        actions.innerHTML = `<button class="button is-small is-primary" id="deleteTask${task.id}" onclick="completeTask('${task.id}');"><span class="icon is-small"><i class="fa fa-check" style="font-size:24px;color:red"></i></span></button>`
