  ...
  fetch('/api/tasks')
    ...
    .then((response) => {
      response.forEach((task) => {
        ...
        actions.innerHTML = `<button class="button is-small is-info" id="deleteTask${task.id}" onclick="completeTask('${task.id}');"><span class="icon is-small"><i class="fa fa-check" style="font-size:24px;color:white"></i></span></button>`
